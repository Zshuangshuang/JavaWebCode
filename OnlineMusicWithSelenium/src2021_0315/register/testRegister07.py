...
# 定位输入框并输入相应内容
browser.find_element_by_id("user").send_keys("小李")
browser.find_element_by_id("user").send_keys(Keys.TAB)
browser.find_element_by_id("password").send_keys("456")
browser.find_element_by_id("password").send_keys(Keys.TAB)
browser.find_element_by_id("age").send_keys(30)
...
browser.find_element_by_id("email").send_keys("xiaoli@qq.com")
