...
# 定位输入框并输入相应内容
browser.find_element_by_id("user").send_keys("邓庄庄")
browser.find_element_by_id("user").send_keys(Keys.TAB)
browser.find_element_by_id("password").send_keys("qwertyuiopasdfghjklzxcvbnmkloiuhytgrfdewsaqzxcvbnmkl")
browser.find_element_by_id("password").send_keys(Keys.TAB)
browser.find_element_by_id("age").send_keys(26)
browser.find_element_by_id("age").send_keys(Keys.TAB)
browser.find_element_by_id("gender").send_keys("男")
browser.find_element_by_id("gender").send_keys(Keys.TAB)
browser.find_element_by_id("email").send_keys("邓庄庄@qq.com")
