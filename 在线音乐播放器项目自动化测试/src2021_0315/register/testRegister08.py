...
# 定位输入框并输入相应内容
browser.find_element_by_id("user").send_keys("张三")
browser.find_element_by_id("user").send_keys(Keys.TAB)
browser.find_element_by_id("password").send_keys("12345678908765432123456789490")
browser.find_element_by_id("password").send_keys(Keys.TAB)
browser.find_element_by_id("age").send_keys(39)
...
browser.find_element_by_id("email").send_keys("zhangsan@qq.com")
